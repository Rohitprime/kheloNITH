...
const NotisReceive = ({ notis }) => {
    ...
    const rejectHandler = async(e)=>{
       ...
       const id= name
       try {
            const res = await axios.get(`http://localhost:3000/kheloNITH/notification/team/reject/${id}`)
    ...
    const acceptHandler = async(e)=>{
        ...
        const id= name
        try {
             const res = await axios.get(`http://localhost:3000/kheloNITH/notification/team/accept/${id}`)
